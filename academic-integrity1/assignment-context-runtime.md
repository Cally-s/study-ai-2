...
> **Step 41 integration:** Student-Contribution Checkpoints record intentional, policy-authorized student decisions and artifacts across the exact nine-stage workflow. They preserve provenance, privacy, accessibility neutrality, Step 37–40 and learning-mode restrictions, final-answer gates, and immutable history without surveillance, authorship scoring, or automatic discipline.

> Step 40 resolves Step 37 context before intervening; unresolved assessed work receives policy clarification and separated learning, while permitted work avoids a false intervention.

> Step 39 consumes the Step 37 context decision before resolving any ladder level; unknown and active-assessment contexts remain conservative and preserve general/support separation.

> Step 38 provides the verified exact-assignment policy that Step 37 reuses before asking students; published versions, effective dates, requirements, and permission states feed the context decision.

## Purpose
Resolve potentially assessed work before task-specific AI support. Ask exactly “What are you working on?” and then “What AI use does your teacher allow?” only when current authorized context/policy is missing.

## Triggers and reuse
Assignment uploads, assessed-work requests, linked workspaces, new tasks, expiry, and conflicts activate resolution. Platform, accessibility, privacy, safety, general policy, and teacher-message help do not wait. Exact stored policies skip repeated questions.

## Runtime decisions
The server resolves allow, disclosure, limited tasks, general learning, clarification, active-assessment/competition blocks, conflict, or human review and snapshots the result per assessed-work message.
...
# Step 61 context integration

The trusted assignment context contributes course, assignment, purpose, destination, school policy, and policy version to the privacy decision. Free text, retrieved content, or client state cannot alter those fields. A context or version mismatch preserves the draft and requires review; it never becomes permission.
