# Student-Contribution Checkpoints

> Step 67 integration: attempt validation confirms the presence and provenance of a student contribution, not its correctness or quality. Missing/unclear provenance leads to a smaller next step or review, never accusation, alerts, or discipline.

> Step 66 integration: Stage 7 validates owned artifact/version/provenance references without word count, timing, typing style, or AI-writing detection. Missing work limits assistance and offers a next step; it never creates misconduct or an alert.

## Step 58 performance evidence
Required student decisions—issue identification, verification, revision, problem/workflow/prototype/test choices, feedback response, limitations, deployment, and reflection—reuse Step 41 records. AI-generated artifacts never satisfy them automatically; group work preserves individual evidence.
...
> **Step 42 integration:** Substantive educational help is presented through the validated Standard AI Response Card in the exact eight-section order. Trusted mode, policy, ladder, checkpoint, source, confidence-basis, verification, next-step, and AI-contribution data remain authoritative; the card creates no permission, exposes no hidden reasoning, uses no numerical confidence, and cannot leak a prohibited answer.

## Purpose

The workflow records meaningful student agency without surveilling every keystroke. Its exact default order is Research Question, Thesis or Position, Evidence, Outline, Draft, Feedback, Revision, Verification, and Disclosure. Each required stage needs an intentional student contribution or decision; policy from Steps 37–40 remains controlling. The visible Student Agency Record summarizes student and AI contributions without proving authorship.
...
## Step 57 assessment evidence
Scenario decisions and student-created reasoning may form response-level evidence. Opening, selecting, counting completions, or vocabulary recall alone cannot complete a checkpoint. Formal linkage is intentional, versioned, and human-reviewed when configured.
# Step 62 contribution boundary

Trusted profiles may require a student attempt before a permitted practice answer. Shorter, spoken, diagram, sorting, or accessible responses remain valid contributions. Age, reading preference, disability, response speed, and safeguard profile never become independence, integrity, readiness, or maturity scores.
# Step 63 accessible contributions

Contribution Checkpoints accept approved written, spoken-with-reviewed-transcript, diagram, sorting, math, code, table, and structured alternatives under identical criteria. No penalty applies for captions, screen readers, TTS/STT, language bridge, reading support, keyboard alternatives, or print use.
